    ...
    <div class="container">
        ...
        if($fast_food_truck_layout_option == 'One Column'){ ?>
            <div id="blog_sec" class="blog-section pt-5">
                <?php if(get_theme_mod('fast_food_truck_post_pagination_position', 'Bottom') == 'Top' || get_theme_mod('fast_food_truck_post_pagination_position', 'Bottom') == 'Both Top & Bottom'){ ?>
                    ...
                    <?php } ?>
                <?php } ?>
                <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','fast-food-truck'), esc_html( get_search_query() ) ); ?></h1> 
        ...
        <?php }else if($fast_food_truck_layout_option == 'Three Columns'){ ?>
            <div class="row">
                ...
                <div id="blog_sec" class="blog-section col-lg-6 col-md-6 mt-5">
                    <h1 class="search-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s','fast-food-truck'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
                    <?php if ( have_posts() ) :
                        /* Start the Loop */          
        ...
        <?php }else if($fast_food_truck_layout_option == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div id="blog_sec" class="<?php if( get_theme_mod( 'fast_food_truck_sidebar_size', 'Sidebar 1/3') == 'Sidebar 1/3') { ?>col-lg-8 col-md-8 blog-section pt-5"<?php } else { ?>col-lg-9 col-md-8 pt-5 <?php } ?>">
                    <?php if(get_theme_mod('fast_food_truck_post_pagination_position', 'Bottom') == 'Top' || get_theme_mod('fast_food_truck_post_pagination_position', 'Bottom') == 'Both Top & Bottom'){ ?>
                        <?php if( get_theme_mod( 'fast_food_truck_enable_post_pagination',true) != '') { ?>
                            <div class="navigation">
                                <?php fast_food_truck_pagination_type(); ?>
