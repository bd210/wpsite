...
<main role="main" id="skip_content">
  <div class="container">
    <?php $fast_food_truck_layout_option = get_theme_mod( 'fast_food_truck_layout_options','Right Sidebar');
    if($fast_food_truck_layout_option == 'One Column'){ ?>
      <div id="blog_sec" class="blog-section pt-5">
        <?php if(get_theme_mod('fast_food_truckfast_food_truck_post_pagination_position', 'Bottom') == 'Top' || get_theme_mod('fast_food_truck_post_pagination_position', 'Bottom') == 'Both Top & Bottom'){ ?>
